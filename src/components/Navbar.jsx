    ...
    <nav className=" bg-transparent py-4  absolute top-0 w-full z-40">
      <div className=" max-w-full sm:max-w-3xl mx-auto px-4 flex justify-between sm:justify-center items-center">
        ...
        <div className="md:flex items-center">
            <a href="https://www.dextools.io/" target="_blank" className="bg-[#ffffff] border-2  rounded-full px-4 py-2 text-xl font-kid  font-semibold box-s2 ">Buy Now</a>
        </div>
      ...
      >
        {(ref) => (
          <div
            ref={ref}
            className="md:hidden bg-white rounded-2xl border-2 border-[#000] px-2 pt-2 pb-3 space-y-1 m-4 z-50"
          >
